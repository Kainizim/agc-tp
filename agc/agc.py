...
def main():
    ...
    OTU_list = abundance_greedy_clustering(os.path.abspath(os.path.join(os.path.dirname(__file__), "/home/sdv/m2bi/hmiziniak/TP/agc-tp/data/amplicon.fasta.gz")), 400, 10, 100, 8)
